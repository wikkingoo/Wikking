...
(function () {
  ...
  var PROJECTS = [
    ...
    { id: "05", title: "海报设计 Poster Design", cat: "Poster", year: "2023-2026", status: "Available",
  ...
  /* Carousel cover overrides (keep in sync with homepage cards) */
  var CAR_COVER = {
  ...
  document.getElementById("prevBtn").addEventListener("click", function () {
    ...
    window.location.href = "work-detail-v3.html?work=" + n;
  });
  ...
  for (var k = 0; k < ORDER.length && shown < 5; k++) {
    ...
    a.href = "work-detail-v3.html?work=" + m;
    ...
    title.textContent = p.title.split(" ")[0];
  ...
  /* ---------- Topbar ticker: duplicate until no gaps ---------- */
  ...
  (function () {
    ...
    if (!unitW) return;
    function fill() {
      var need = Math.ceil((tickerEl.clientWidth * 2) / unitW);
